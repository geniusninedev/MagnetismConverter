package com.nineinfosys.magnetismconverter.LoginActivity;
...
import com.nineinfosys.magnetismconverter.MainActivity;
import com.nineinfosys.magnetismconverter.R;
import com.nineinfosys.magnetismconverter.models.User;
...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#8e918e")));
